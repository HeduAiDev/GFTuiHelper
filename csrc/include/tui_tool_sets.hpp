...
namespace tui {
    namespace component {
        ...
        Component InputFormCreateFromJsonStr(std::string json_str, std::unordered_map<std::string, StringRef> &input_text_map, std::unordered_map<std::string, Ref<int>>& input_select_index_map, \
